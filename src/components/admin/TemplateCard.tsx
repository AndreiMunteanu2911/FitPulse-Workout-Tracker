  ...
  return (
    <div className="bg-[var(--surface)] rounded-[var(--radius-md)] p-4 sm:p-5 transition-all duration-200">
      <div className="flex items-center justify-between gap-4">
        ...
        <button
          onClick={onDelete}
          className="w-9 h-9 rounded-full bg-[var(--surface-raised)] hover:bg-[var(--color-destructive-bg)] flex items-center justify-center transition-colors flex-shrink-0"
        >
