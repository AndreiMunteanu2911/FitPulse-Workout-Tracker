...
export default function PersonalRecordCard({ record }: PersonalRecordCardProps) {
  ...
  return (
    <div className="bg-[var(--surface)] border border-[var(--border)] rounded-lg p-4 hover:shadow-md transition-shadow">
      ...
      <div className="grid grid-cols-3 gap-2 text-center">
        <div className="bg-[var(--primary-50)] dark:bg-[var(--primary-800)] rounded-lg p-3">
          <p className="text-xs text-[var(--muted-foreground)]">Max Weight</p>
          <p className="text-xl font-bold text-[var(--primary-700)] dark:text-[var(--primary-200)]">
        ...
        <div className="bg-[var(--primary-50)] dark:bg-[var(--primary-800)] rounded-lg p-3">
          ...
          <p className="text-sm font-semibold text-[var(--primary-700)] dark:text-[var(--primary-200)]">
      ...
      {record.max_weight > 0 && record.max_reps > 0 && (
        <div className="mt-3 text-center text-sm text-[var(--muted-foreground)]">
          Est. 1RM: <span className="font-semibold text-[var(--primary-600)]">{Math.round(record.max_weight * (1 + record.max_reps / 30))} kg</span>
        </div>
      )}
    </div>
  );
